...
import numpy as np
import pandas as pd
from raven.utilities.ffa_tools import flood_frequency_analysis as ffa
...
def Q1max2Sp(df, dist='gumbel_r'):
    ...
    Q1max2Sp, _ = ffa(Sp_max, dist=dist, T=2)
    return Q1max2Sp
...
def Q1max20Sp(df, dist='gumbel_r'):
    ...
    trimester_max = df.resample('QS-Dec', on='dates').agg({'Q': 'max'})['Q']
    Sp_max = trimester_max.iloc[1::4]
    Q1max20Sp,_ = ffa(Sp_max, dist=dist, T=20)
    return Q1max20Sp
...
def Q14max2Sp(df, dist='gumbel_r'):
    ...
    Sp_max = trimester_max.iloc[1::4]
    Q14max2Sp,_ = ffa(Sp_max, dist=dist, T=2)
    return Q14max2Sp
...
def Q14max20Sp(df, dist='gumbel_r'):
    ...
    trimester_max = df.resample('QS-Dec', on='dates').agg({'Q14': 'max'})['Q14']
    Sp_max = trimester_max.iloc[1::4]
    Q14max20Sp,_ = ffa(Sp_max, dist=dist, T=20)
    return Q14max20Sp
...
def Q1max2SuA(df, dist='gumbel_r'):
    ...
    Q1max2SuA,_ = ffa(SuA_max, dist='gumbel_r', T=2)
    return Q1max2SuA
...
def Q1max20SuA(df, dist='gumbel_r'):
    ...
    semester_max = df.resample('2QS-Dec', on='dates').agg({'Q': 'max'})['Q']
    SuA_max = semester_max.iloc[1::2]
    Q1max20SuA,_ = ffa(SuA_max, dist=dist, T=20)
    return Q1max20SuA
...
def Q7min2Su(df, dist='gumbel_r'):
    ...
    Q7min2Su,_ = ffa(Su_min, dist=dist, T=2)
    return Q7min2Su
...
def Q7min10Su(df, dist='gumbel_r'):
    ...
    trimester_min = df.resample('QS-Dec', on='dates').agg({'Q7': 'min'})['Q7']
    Su_min = trimester_min.iloc[2::4]
    Q7min10Su,_ = ffa(Su_min, dist='gumbel_r', T=10)
    return Q7min10Su
...
def Q30min5Su(df, dist='gumbel_r'):
    ...
    Su_min = trimester_min.iloc[2::4]
    Q30min5Su,_ = ffa(Su_min, dist=dist, T=5)
    return Q30min5Su
...
def Q7min2W(df, dist='gumbel_r'):
    ...
    Q7min2W,_ = ffa(W_min, dist=dist, T=2)
    return Q7min2W
...
def Q7min10W(df, dist='gumbel_r'):
    ...
    trimester_min = df.resample('QS-Dec', on='dates').agg({'Q7': 'min'})['Q7']
    W_min = trimester_min.iloc[0::4]
    Q7min10W,_ = ffa(W_min, dist=dist, T=10)
    return Q7min10W
...
def Q30min5W(df, dist='gumbel_r'):
    ...
    trimester_min = df.resample('QS-Dec', on='dates').agg({'Q30': 'min'})['Q30']
    W_min = trimester_min.iloc[0::4]
    Q30min5W,_ = ffa(W_min, dist=dist, T=5)
    return Q30min5W
...
def extract_all_indicators(df, dist='gumbel_r', **kwds):
    """
